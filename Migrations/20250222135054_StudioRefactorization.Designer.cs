...
namespace PhiZoneApi.Migrations
{
    ...
    [Migration("20250222135054_StudioRefactorization")]
    partial class StudioRefactorization
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PhiZoneApi.Models.Submission", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("DateFileUpdated")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("PhiZoneApi.Models.EventDivision", b =>
                {
                    ...
                    b.Property<string>("SuggestedEntrySearch")
                        .HasColumnType("text");
