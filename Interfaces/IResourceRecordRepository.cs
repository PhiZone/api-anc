...
{
    Task<ICollection<ResourceRecord>> GetResourceRecordsAsync(List<string> order, List<bool> desc, int position, int take,
    ...
    Task<int> CountResourceRecordsAsync(string? search = null, Expression<Func<ResourceRecord, bool>>? predicate = null);
}