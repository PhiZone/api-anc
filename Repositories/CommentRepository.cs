...
public class CommentRepository : ICommentRepository
{
    ...
    public async Task<ICollection<Comment>> GetCommentsAsync(string order, bool desc, int position, int take,
    ...
    public async Task<ICollection<Reply>> GetCommentRepliesAsync(Guid id, string order, bool desc, int position,
